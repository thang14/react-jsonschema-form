...
var FileWidget = function (_Component) {
  ...
  function FileWidget(props) {
    ...
    _this.onChange = function (event) {
      ...
      processFiles(event.target.files).then(function (filesInfo) {
        var state = {
          values: _this.state.values.concat(filesInfo.map(function (fileInfo) {
            return fileInfo.dataURL;
          })),
          filesInfo: _this.state.filesInfo.concat(filesInfo)
        };
  ...
  _createClass(FileWidget, [{
    key: "renderImagesView",
    value: function renderImagesView() {
      var _this2 = this;

      var classes = this.props.classes;

      var values = this.state.values.filter(function (value) {
        return value != undefined;
      });
      if (values.length == 0) {
        return null;
      }
      var files = values.map(function (file, key) {
        return _react2.default.createElement(
          "li",
          { key: key, className: classes.fileItem },
          _react2.default.createElement(
            "span",
            { className: classes.deleteIcon, onClick: function onClick() {
                _this2.state.values.splice(key, 1);
                (0, _utils.setState)(_this2, {
                  values: _this2.state.values,
                  filesInfo: _this2.state.filesInfo
                });
              } },
            _react2.default.createElement(_Delete2.default, null)
          ),
          _react2.default.createElement("img", { className: classes.fileViewImage, src: file })
        );
      });
      return _react2.default.createElement(
        "ul",
...
exports.default = (0, _styles.withStyles)(styles)(FileWidget);